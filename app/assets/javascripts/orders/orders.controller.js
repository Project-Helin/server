(function () {
    angular.module('OrdersApp').controller('OrdersController',
        ['$scope', '$http', 'ProductsService', 'OrdersService', 'CustomersService',
            function ($scope, $http, ProductsService, OrdersService, CustomersService) {
                ...
                $scope.sendConfirmRequest = function (orderId) {
                    ...
                    CustomersService
                        .save('test@mail.com', 'Peter', 'Mueller')
                        .then(function (customer) {
                            OrdersService
                                .confirmOrder(orderId, customer.id)
                                .then(function () {
                                    // reload current page
                                    location.reload();
