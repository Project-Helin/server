...
public class RouteHelperTest {
    ...
    public void shouldConvertPositionListToRoute(){
        ...
        ch.helin.messages.dto.way.Position pos0 = new ch.helin.messages.dto.way.Position();
        pos0.setHeight(1);
        pos0.setLon(2.0);
        pos0.setLat(3.0);
        positions.add(pos0);

        ch.helin.messages.dto.way.Position pos1 = new ch.helin.messages.dto.way.Position();
        pos1.setHeight(4);
        pos1.setLon(5.0);
        pos1.setLat(6.0);
        positions.add(pos1);

        ch.helin.messages.dto.way.Position pos2 = new ch.helin.messages.dto.way.Position();
        pos2.setHeight(7);
        pos2.setLon(8.0);
        pos2.setLat(9.0);
        positions.add(pos2);
